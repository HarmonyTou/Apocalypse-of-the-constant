local assets = {
    Asset("ANIM", "anim/armor_nightmare.zip"),
...
local function onequip(inst, owner)
    ...
    if skin_build ~= nil then
        ...
        owner.AnimState:OverrideItemSkinSymbol("swap_body", skin_build, "swap_body", inst.GUID, "armor_nightmare")
    else
        owner.AnimState:OverrideSymbol("swap_body", "armor_nightmare", "swap_body")
    end

    if inst.fx ~= nil then
        inst.fx:Remove()
    end
    inst.fx = SpawnPrefab("armor_nightmare_fx")
...
local SWAP_DATA_BROKEN = { bank = "armor_nightmare", anim = "broken" }
local SWAP_DATA = { bank = "armor_nightmare", anim = "anim" }
...
local function fn()
    ...
    inst.AnimState:SetBank("armor_nightmare")
    inst.AnimState:SetBuild("armor_nightmare")
    inst.AnimState:PlayAnimation("anim")
...
return Prefab("armor_nightmare", fn, assets, prefabs),
    Prefab("armor_nightmare_fx", fxfn, assets)
