...
local function fn()
    ...
    inst.AnimState:SetSymbolBloom("dreadspear_fx")
    inst.AnimState:SetSymbolLightOverride("dreadspear_fx", .6)--该方法可以针对图层设定光覆盖
...
local function fxfn()
    ...
    inst.AnimState:SetSymbolBloom("dreadspear_fx")
    inst.AnimState:SetSymbolLightOverride("dreadspear_fx", 1.5)
